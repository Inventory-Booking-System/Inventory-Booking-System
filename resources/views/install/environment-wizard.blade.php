        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="url" name="app_url" id="app_url" value="{{ old('app_url', url('/')) }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_url_placeholder') }}" />
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('database_hostname') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_hostname" id="database_hostname" value="{{ old('database_port', '127.0.0.1') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.db_host_placeholder') }}" />
            ...
            <div class="tab" id="tab3content">
                <div class="form-group {{ $errors->has('mail_driver') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="mail_driver" id="mail_driver" value="{{ old('mail_driver', 'smtp') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_driver_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('mail_host') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="mail_host" id="mail_host" value="{{ old('mail_host') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_host_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('mail_port') ? ' has-error ' : '' }}">
                    ...
                    <input type="number" name="mail_port" id="mail_port" value="{{ old('mail_port', '587') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_port_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('mail_username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="mail_username" id="mail_username" value="{{ old('mail_username', 'null') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_username_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('mail_password') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="mail_password" id="mail_password" value="{{ old('mail_password', 'null') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_password_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('mail_encryption') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="mail_encryption" id="mail_encryption" value="{{ old('mail_encryption', 'null') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_encryption_placeholder') }}" />
            ...
            <div class="tab" id="tab4content">
                ...
                <div class="form-group {{ $errors->has('account_forename') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="account_forename" id="account_forename" value="{{ old('account_forename') }}" />
                ...
                <div class="form-group {{ $errors->has('account_surname') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="account_surname" id="account_surname" value="{{ old('account_surname') }}" />
                ...
                <div class="form-group {{ $errors->has('account_email') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="account_email" id="account_email" value="{{ old('account_email') }}" />
